...
A la détection d'une création de fichier ou de modification de fichier texte ou de renommage d'un fichier vers un format textuel, le moteur d'indexation doit lancer l'indexation du fichier afin de stocker un certain nombre de mots dans la base de données\index{Base de donn\'{e}es}.
